...
namespace CreativeSpore.SuperTilemapEditor.PlayMakerActions
{
    ...
    //[HelpUrl("")]
    public class GetTileIntParameter : PositionalActionBase
    {
        [HutongGames.PlayMaker.ActionSection("Output")]

        [UIHint(UIHint.Variable)]
        [Tooltip("The value of the parameter.")]
        public FsmInt parameterValue;
        ...
        public override void OnEnter()
        {
            ...
            if (UpdateCache(go))
            {
                ...
                if (tile == null)
                    ...
                    parameterValue.Value = tile.paramContainer.GetIntParam(parameterName.Value, defaultValue.Value);
            }
