...
namespace CreativeSpore.SuperTilemapEditor.PlayMakerActions
{
    ...
    //[HelpUrl("")]
    public class GetTileStringParameter : PositionalActionBase
    {
        [HutongGames.PlayMaker.ActionSection("Output")]

        [UIHint(UIHint.Variable)]
        [Tooltip("The value of the parameter.")]
        public FsmString parameterValue;
        ...
        public override void OnEnter()
        {
            ...
            if (UpdateCache(go))
            {
                ...
                if (tile == null)
                    ...
                    parameterValue.Value = tile.paramContainer.GetStringParam(parameterName.Value, defaultValue.Value);
            }
